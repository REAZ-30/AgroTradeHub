...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['bkash_mobile'])) $errors[] = 'bKash mobile number is required';
    if (empty($_POST['bkash_transaction'])) $errors[] = 'bKash transaction ID is required';
                            ...
                            <div class="bkash-payment">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="bkash_mobile" placeholder="01XXXXXXXXX" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="bkash_transaction" placeholder="TRX123456789" required>
